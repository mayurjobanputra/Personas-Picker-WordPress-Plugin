...
function persona_tabs_shortcode($atts) {
    ...
    //include typeout.js which is in same directory as the index.php file of this plugin installed in wordpress
    $output .= "<script src='/wp-content/plugins/personas-picker/typeout.js'></script>";
    $output .= "<script>
        jQuery(document).ready(function() {
            jQuery('.tab-pane').hide();
            jQuery('.persona-choice a').click(function() {
                jQuery('.tab-pane').hide();
                //stop the typewriter effect when someone clicks on a persona title generated by the persona_picker shortcode
                jQuery('.typeout').typeOut('typeOutStop');
