...
function persona_tabs_shortcode($atts) {
    ...
    //some css to wrap the text using text-wrap: wrap
    ...
    $output .= "<script>jQuery(document).ready(function(){jQuery('.tab-pane').hide();jQuery('.persona-choice a').click(function(){jQuery('.tab-pane').hide();jQuery(jQuery(this).attr('href')).show().find('.typeout').typeOut();});});</script>"; 
